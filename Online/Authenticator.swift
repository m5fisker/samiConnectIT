...
class Authenticator: NSObject, SAPURLSessionDelegate {
    ...
    struct Constants {
        static let appID = "dubai.customer"
        static let connectionID = "ODataSampleService"
        private static let sapcpmsURLString = "https://hcpms-d048098trial.hanatrial.ondemand.com/"
